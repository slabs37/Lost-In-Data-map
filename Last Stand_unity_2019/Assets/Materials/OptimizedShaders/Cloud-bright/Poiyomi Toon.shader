Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/aefc2cf77029002448a906d2fb03c8ea"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (-0.65 /*_AlphaMod*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6070304,0.6070304,0.6070304,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.6070304,0.6070304,0.6070304,1).a;
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiFragData.alpha = saturate(poiFragData.alpha * (1.0 /*_AlphaBoostFA*/));
				}
