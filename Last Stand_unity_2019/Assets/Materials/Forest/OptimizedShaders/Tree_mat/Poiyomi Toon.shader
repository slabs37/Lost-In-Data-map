Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/e1264dc8ba92aea4bb3f7a249453f716"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				{
					v.vertex.xz = lerp(v.vertex.xz, float3(v.vertex.xz + float2(cos(_Time.y * (1.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (1.0 /*_VertexTornadoRadius*/), sin(_Time.y * (1.0 /*_VertexTornadoSpeed*/) + v.vertex.y * (100.0 /*_VertexTornadoIntensity*/)) * (1.0 /*_VertexTornadoRadius*/)), v.vertex.y), smoothstep((0.0 /*_VertexTornadoBaseHeight*/), (100.0 /*_VertexTornadoTopHeight*/), v.vertex.y));
				}
			...
			{
				poiFragData.alpha = saturate(poiFragData.alpha + (0.48 /*_AlphaMod*/));
