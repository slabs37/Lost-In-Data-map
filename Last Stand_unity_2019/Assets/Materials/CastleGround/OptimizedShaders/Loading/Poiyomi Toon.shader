Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/dd9d9e812d1dac046919ee405183f4e3"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float2 mainUV = poiUV(poiMesh.uv[(0.0 /*_MainTexUV*/)].xy, float4(-0.85,0.85,-0.07,0.07));
				...
				clip(poiFragData.alpha - (0.055 /*_Cutoff*/));
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiFragData.alpha = saturate(poiFragData.alpha * (30.8 /*_AlphaBoostFA*/));
				}
