Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/81d5c81f2dc70fd4aa37cbd3a9b438e5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, (0.362 /*_OutlineShadowStrength*/));
				#endif
				#ifdef _LIGHTINGMODE_REALISTIC
				UnityLight light;
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.9734455,0.5028866,0.6795426,0);
				#ifdef POI_AUDIOLINK
				...
				{
					float4 hsvg = float4((0.0 /*_OutlineHue*/) ,(1.0 /*_OutlineSaturation*/) ,(0.1 /*_OutlineValue*/) ,(1.0 /*_OutlineGamma*/));
				...
				float emission = (0.1 /*_OutlineEmission*/);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
