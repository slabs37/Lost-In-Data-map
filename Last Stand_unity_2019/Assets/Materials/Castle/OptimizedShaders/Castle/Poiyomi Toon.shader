Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6bce23ea2dace7947adc0f4867687d1b"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void ApplyDetailNormal(inout PoiMods poiMods, inout PoiMesh poiMesh)
			{
				...
				#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_DetailNormalMap, _MainTex, poiUV(poiMesh.uv[(5.0 /*_DetailNormalMapUV*/)], float4(0.75,0.75,0,0)), float4(0,0,0,0), (0.0 /*_DetailNormalMapStochastic*/)), (1.0 /*_DetailNormalMapScale*/) * poiMods.detailMask.g);
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, (1.0 /*_RefSpecFresnelStrength*/)) * (1.0 /*_RefSpecFresnelStrength*/), pbrNDotV);
